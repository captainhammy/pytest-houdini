...
:mod:`pytest-houdini` also provides some other, more general fixtures that while perhaps not explicitly for Houdini are
useful for testing.

remove_abstract_methods
-----------------------

The :func:`~pytest_houdini.fixtures.other.remove_abstract_methods` fixture is used to temporarily remove an object's abstract methods.
...
Without this we would hit a :exc:`TypeError` due to the abstract method.
